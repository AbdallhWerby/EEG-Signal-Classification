...
for j = delta_col_indices % iterate over columns containing delta data
    delta_data_second = [delta_data_second Matrix_a(i:i+159, j)']; % select rows i to i+159 and column j, transpose, and concatenate horizontally
end
...
for j = theta_col_indices % iterate over columns containing theta data
    theta_data_second = [theta_data_second Matrix_a(i:i+159, j)']; % select rows i to i+159 and column j, transpose, and concatenate horizontally
end
...
for j = alpha_col_indices % iterate over columns containing alpha data
    alpha_data_second = [alpha_data_second Matrix_a(i:i+159, j)']; % select rows i to i+159 and column j, transpose, and concatenate horizontally
end
...
for j = beta_col_indices % iterate over columns containing beta data
    beta_data_second = [beta_data_second Matrix_a(i:i+159, j)']; % select rows i to i+159 and column j, transpose, and concatenate horizontally
end
